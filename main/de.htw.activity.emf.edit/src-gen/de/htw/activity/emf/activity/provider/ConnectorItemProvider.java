...
/**
 * This is the item provider adapter for a {@link de.htw.activity.emf.activity.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider extends ControlNodeItemProvider {
	/**
	...
	protected void addConnectedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connector_connected_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connector_connected_feature",
								"_UI_Connector_type"),
						ActivityPackage.Literals.CONNECTOR__CONNECTED, true, false, true, null, null, null));
	}
